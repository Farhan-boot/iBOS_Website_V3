        ...
        <div class="hero-section hero-another-section product-bg">
            <div class="container">
                <div class="hero-content">
                    ...
                    <p class="hero-para">
                        Each of the products we’ve created are made to bring perfection and error-freeness in your business process. So, have a glance at our products and get an idea about how it’s going to make the A-to-Z of your business easier than ever. 
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-4">
                        <div class="single-product-top-info">
                            ...
                            <p class="mini-info">Small Enterprise</p>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-4">
                        <div class="single-product-top-info">
        ...
        <div class="product-information-section">
            <div class="container">
                <div class="title-section">
                    <h2 class="section-title">Solutions We Take Pride in</h2>
                    <p class="section-para">
                       We don’t make software, we create the solution of problems and here are some of them that will eliminate your problem from the root.
                    </p>
                </div>
 ...
 <?php endwhile; ?>
    ...
    <section>
        <div class="product-video-section">
            <div class="container">
                <div class="title-section">
                    <h2 class="section-title">The Way Our Software Makes Your Business Easier</h2>
                    <p class="section-para">
                       Our software is all about eliminating your problems from the equation.Wanna see how it pulls that off?
                    </p>
                </div>
                <div class="product-video-section-content">
                    <div class="product-video-section-img">
                        ...
                        <div class="product-video-section-img-overlay">
                            <a class="play-btn mfp-iframe" href="https://www.youtube.com/watch?v=Hbt-dBGl_CU?autoplay=1&rel=0;">
                        ...
                        <div class="idea-ellipse-section">
                            ...
                            <div class="container">
                                <div class="ideas-ellipse-content">
                                    ...
                                    <p>
                                       We’ve got what you need. All you have to do is just choose which one you think will fix that up in the best way for your large, medium, or small organization.
                                    </p>
                                    ...
                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                            ...
                                            <div id="collapseOne" data-parent="#accordion"
                                                ...
                                                <div class="panel-body">
                                                    <p class="welcome-para">
                                                        If you have a large enterprise you’re having hard time dealing with, then iBOS can come to your rescue.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseTwo" data-parent="#accordion"
                                                ...
                                                <div class="panel-body">
                                                    <p class="welcome-para">
                                                       Trust iBOS for your medium enterprise and find any solutions from our shelf that suits your needs.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseThree" data-parent="#accordion"
                                                ...
                                                <div class="panel-body">
                                                    <p class="welcome-para">
                                                        Even if your business is a small one, we got you covered. You can pick solutions like SME suiting your needs or let us build one for you.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
