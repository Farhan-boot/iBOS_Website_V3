        ...
        <div class="hero-section hero-another-section industry-bg">
            <div class="container">
                <div class="hero-content">
                    <h2>Industries</h2>
                    <p class="hero-para">
                       There’s no industry that we can’t serve with our solutions. Regardless of the industry your business belongs to, we bet you won’t go back without having anything according to your need.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="industry-card-section">
            <div class="container">
                <div class="title-section">
                    <h2 class="section-title">iBOS Solutions: For Any Industry You Can Name</h2>
                    <p class="section-para">
                        Get a glance at the major industries we’ve been working with for years.
                    </p>
                </div>
        ...
        <div class="idea-ellipse-section about-idea-ellipse industry-idea-ellipse">
            ...
            <div class="container">
                <div class="ideas-ellipse-content">
                    <h2>
                      Can’t Find Your Suitable Industry?
                    </h2>
                    <p>
                     Reach out to us with what you need so that we can help you with proper support & solutions.
                    </p>
