...
const serveitmes = $(".serve-items");

  serveitmes.on('wheel', (function(e) {
    e.preventDefault();
...
//Extra Javascript
//change free trail text
var btnElements = document.querySelectorAll('.explore .service-btn span');
for ( var i=btnElements.length; i--; ) {
    btnElements[i].textContent = "Free Trial Here!";
}

//Case Study Disabled
var caseStudy = document.querySelectorAll(".industry-case-section");
for ( var i=caseStudy.length; i--; ) {
   caseStudy[i].style.display = "none";
}