                                ...
                                <div class="contact-info-txt">
                                    ...
                                    <ul class="contact-info-list">
                                        <li class="single-contact-info-list">
                                            <div class="icon">
                                                <img src="https://ibos.io/wp-content/uploads/2021/08/message.png" alt="iBOS" />
                                            </div>
                                            <p>info@ibos.io</p>
                                        </li>
                                        <li class="single-contact-info-list">
                                            <div class="icon">
                                                <img src="https://ibos.io/wp-content/uploads/2021/08/mobile.png" alt="iBOS" />
                                            </div>
                                            <p>
                                                <a href="tel:+88001545485485">01703-596292</a>
                                            </p>
                                        </li>
                                        <li class="single-contact-info-list">
                                            <div class="icon">
                                                <img src="https://ibos.io/wp-content/uploads/2021/08/location.png" alt="iBOS" />
                                            </div>
                                            <p>
                            ...
                            <form action="#" class="contact-info-form">
                                ...
                                <script>
                                  hbspt.forms.create({
                                	region: "na1",
                                	portalId: "20280711",
                                	formId: "22b9d35f-c34d-44a0-8c68-f90bada50e92"
                                });
                                </script>
            ...
            <div class="idea-ellipse-section">
                ...
                <div class="container">
                    <div class="ideas-ellipse-content">
                        ...
                        <p>
                           Just give a call so we can help you with more appropriate guidelines
                        </p>
